...
public class WebDriverUtility {
	...
	/**
	 * This method is used to clear Browser History
	 * @param driver
	 */
	public void clearBrowserHistory(WebDriver driver) {
		...
		while(it.hasNext()) {
			...
			if(driver.getTitle().contains("setting")|| driver.getTitle().contains("Settings")) {
				break;
			}
		}
		try {
